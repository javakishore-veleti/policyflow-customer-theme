...
THEME_TITLE="PolicyFlow Customer Theme"
...
name: '$THEME_TITLE'
type: theme
description: 'A custom Drupal theme for PolicyFlow customer portal.'
...
{
  "name": "policyflow/customer-theme",
  "description": "Drupal theme for PolicyFlow customer portal",
  "type": "drupal-theme",
  "license": "Apache-2.0",
